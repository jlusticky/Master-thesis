...
The variables exported via procfs are accessible as files located in /proc.
...
\item /proc/sys/net/core - variables influencing low-level networking settings, including parameters of NAPI, Low Latency Sockets, etc.
\end{itemize}
