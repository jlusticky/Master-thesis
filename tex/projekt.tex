...
\projectinfo{
  ...
  %Nazev prace
  title.cs={Směrování 40Gbit v Linuxu},  %nazev prace v cestine
  title.en={Towards 40Gbit Linux Router}, %nazev prace v anglictine
  %Autor
  ...
  acknowledgment={Děkuji vedoucímu práce Ing. Matějovi Grégrovi za poskytnutí praktických rad,
  vybaveného pracovního místa v laboratoři a pomoc při sestavování hardwaru.} % nepovinne
}
